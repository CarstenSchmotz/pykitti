...
%\newline
This section presents the results of the  experiments using different setups to predict LIDAR intensity. It was  evaluated the performance of several methods, including depth from BP Net to LIDAR, RGB plus depth from BP Net to LIDAR, , and combinations involving Depth Anything v1 and v2, as well as metric depth estimation. The returning pict The results from eight runs are summarized below:
%\newpage
